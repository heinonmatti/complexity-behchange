...
* Dataset of 20 individuals with 9 self-report variables (and time of response) each, used for testing data generating processes [here](https://raw.githubusercontent.com/heinonmatti/complexity-behchange/master/data/data_20p_9var_plus_time.tsv).
